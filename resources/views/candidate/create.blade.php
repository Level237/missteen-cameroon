        ...
        <div class="grid grid-cols-1">
          <div class="col-span-5 xl:col-span-3">
            ...
            >
              ...
              <div class="p-7">
                <form action="{{ route('candidate.store') }}" enctype="multipart/form-data">
                    @csrf
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        <option value="Miss Teen Cameroon" class="text-body">Miss Teen Cameroon</option>
                        <option value="Mister Teen Cameroon" class="text-body">Mister Teen Cameroon</option>
                        <option value="Miss Teen Petite Cameroon" class="text-body">Miss Teen Petite Cameroon</option>
                        <option value="Miss Teen Curve Cameroon" class="text-body">Miss Teen Curve Cameroon</option>
                        <option value="Miss Pre-Teen Cameroon" class="text-body">Miss Pre-Teen Cameroon</option>
                    </select>
                      <span
