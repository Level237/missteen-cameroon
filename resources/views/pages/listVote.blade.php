...
@section('title',"Listes des Votes")
    ...
    <tbody>
        ...
        <tr>
            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark ">
                <p class="text-black dark:text-white text-center">{{ $index }}</p>
              </td>
            <td
            ...
            >
              ...
              <p class="text-sm mt-2 text-black dark:text-white font-bold">{{ $candidate->candidate_name }}</p>
            </td>
            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
