      ...
      <ul class="flex flex-col p-4 gap-5 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0   dark:border-gray-700">
        ...
        <li class="relative" id="menu2">
          ...
          <li class="relative" id="menu4">
            <a onmouseover="mouseOver4()"  href="{{ route('candidate.list') }}" class="block py-2 px-3  text-white rounded md:bg-transparent  md:p-0" aria-current="page">Voter</a>
        ...
        <li>
          <a href="#" class="block py-2 px-3 text-white  rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#f1c802] md:p-0     md:dark:hover:bg-transparent dark:border-gray-700">Nous Contactez</a>
        </li>
        <li>
