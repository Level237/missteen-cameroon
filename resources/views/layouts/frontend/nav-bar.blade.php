    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul class="flex flex-col p-4 gap-2 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0   dark:border-gray-700">
        <li id="menu3" onmouseover="mouseOver1()" class="relative">
          <a style="color: #c18a19"  class="block cursor-pointer py-2 px-3 font-bold rounded md:bg-transparent  md:p-0" aria-current="page">A Propos de nous</a>
          <div id="sub3" onmouseover="mouseOver1()" onmouseout="mouseOut1()"  class="absolute hidden   flex-col bg-white mt-5 pb-[4rem] ml-[-2rem] pt-4 pl-3 w-[12rem]   h-16">
            <div class="text-sm hover:text-[#c18a19] cursor-pointer mb-1">
                <a href='/comming-soon'>
                Du Concours
                </a>
            </div>
        ...
        <li id="menu1" class="relative">
          <a  style="color: #000"  class="block cursor-pointer py-2 px-3 text-white  rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#f1c802] md:p-0     md:dark:hover:bg-transparent dark:border-gray-700">Hall Of Fame</a>
        ...
        <li class="relative" id="menu2">
            <a  style="color: #000"  onmouseover="mouseOver2()"  href="{{ route('candidate.list') }}" class="block py-2 px-3  text-white rounded md:bg-transparent  md:p-0" aria-current="page">Postuler</a>
          ...
          <li class="relative" id="menu4">
            <a  style="color: #000"  onmouseover="mouseOver4()"   class="block py-2 cursor-pointer px-3  text-white rounded md:bg-transparent  md:p-0" aria-current="page">Voter</a>
        ...
        <li>
          <a  style="color: #000"  href="{{ route('contact.index') }}" class="block py-2 px-3 text-white  rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#f1c802] md:p-0     md:dark:hover:bg-transparent dark:border-gray-700">Nous Contacter</a>
        </li>
        <li>
            <a  style="color: #000"  href='/comming-soon' class="block py-2 px-3 text-white  rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#f1c802] md:p-0     md:dark:hover:bg-transparent dark:border-gray-700">Acheter un ticket</a>
        </li>
      </ul>
    </div>
    </div>
