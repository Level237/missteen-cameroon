                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
                    <div class="group relative overflow-hidden">
                        <div class="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                            <img src="assets/images/blog/miss1.jpg" class="group-hover:scale-110 duration-500 object-cover w-full h-64" alt="">
                        </div>
                    ...
                    <div class="group relative overflow-hidden">
                        <div class="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                            <img src="assets/images/blog/miss3.jpg" class="group-hover:scale-110 duration-500 object-cover w-full h-64" alt="">
                        </div>
